							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<select id="carrera" class="form-control" name="carrera">
										<option></option>
										<option value="LISC">LISC - Licenciatura en Ingenieria de Sistemas Computacionales</option>
										<option value="LCI">LCI - Licenciatura en Comercio Internacional</option>
										<option value="LPM">LPM - Licenciatura en Publicidad y Mercadotecnia</option>
										<option value="LE">LE - Licenciatura en Enfermeria</option>
										<option value="LDGM">LDGM - Licenciatura en Diseño Grafico y Multimedia</option>
									</select>
								</div>
								<!-- Beca -->
								<div class="col-md-1">
