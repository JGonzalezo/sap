...
<?php
  ...
  $sql="INSERT INTO estudiante(ap, am, nombre, f_nac, edad, edo_civil, curp, tel, cel, correo, calle, num_ext, num_int, col, cdad, cdad_nac, edo_nac, pais_nac, esc_proc, esp, prom_ant, f_egr,  campus, carrera, beca, grado, asignaturas, mat1, mat2, mat3, mat4, mat5, mat6, mat7, mat8, mensual, ctco_em, par_em, tel_em, seguro, ale_enf, obs)
  VALUES ('$ap', '$am', '$nombre',
  ...
  '$grado', '$numMat', '$mat1', '$mat2', '$mat3',
  '$mat4', '$mat5', '$mat6', '$mat7', '$mat8',
